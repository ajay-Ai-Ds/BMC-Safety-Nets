      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <div className="flex space-x-3">
              <a
                ...
                className="flex items-center justify-center w-10 h-10 rounded-full bg-slate-800 hover:bg-primary-light text-white transition-colors duration-200"
                aria-label="Call Us"
              >
              ...
              <a
                ...
                className="flex items-center justify-center w-10 h-10 rounded-full bg-slate-800 hover:bg-accent text-white transition-colors duration-200"
        ...
        <div className="border-t border-slate-800 pt-8 mt-8 flex flex-col md:flex-row items-center justify-between text-xs text-slate-500">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="#" className="hover:text-slate-400 hover:underline">Privacy Policy</a>
            <a href="#" className="hover:text-slate-400 hover:underline">Terms & Conditions</a>
            <a href="#faq" onClick={(e) => handleNavClick(e, "#faq")} className="hover:text-slate-400 hover:underline">FAQ</a>
          </div>
        </div>
      </div>
    </footer>
