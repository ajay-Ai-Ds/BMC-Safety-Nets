  ...
  return (
    <>
        ...
        <AnimatePresence>
          {isVisible && (
            <motion.button
              ...
              whileHover={{ scale: 1.1 }}
              className="flex items-center justify-center w-11 h-11 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-full shadow-md border border-slate-200 cursor-pointer transition-colors duration-200"
      ...
      <div className="sm:hidden fixed bottom-0 left-0 w-full bg-white border-t border-slate-200 shadow-[0_-4px_12px_rgba(0,0,0,0.08)] grid grid-cols-2 p-3 gap-3 z-50">
        <a
          href="tel:+917795515500"
          className="flex items-center justify-center space-x-2 bg-primary text-white py-3 px-4 rounded-xl text-base font-bold active:scale-95 transition-transform"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center space-x-2 bg-accent text-white py-3 px-4 rounded-xl text-base font-bold active:scale-95 transition-transform"
        >
